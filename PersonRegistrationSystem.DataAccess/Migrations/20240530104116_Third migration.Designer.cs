...
namespace PersonRegistrationSystem.DataAccess.Migrations
{
    ...
    [Migration("20240530104116_Third migration")]
            ...
            modelBuilder.Entity("PersonRegistrationSystem.DataAccess.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            PasswordHash = "9WWQLzJv/BK6W/At6RoMuGObuwy9wG1ojJ1GuuK1XKfFUAIaYCdFg+RCEPP2n1EkCASzj9ZN7yf19bECYH1YCw==",
                            Role = "Admin",
                            Salt = "6GfAHbJe9oohU9O8D9ArMjvNQDty4czhiAHp+WzlB7SV7vaHCdlAP0d2bSxmWwQaZMR5XaAPsKcW1OeaSgBQ7M8744PzUNaQVI1zzvFwHHwlf02L6o480Omer7fr9AgNAIQpx5zI8o/f+kOe4l4LXueWS2D5on0pbXzhCSRyOtQ=",
                            Username = "admin"
                        });
                });
